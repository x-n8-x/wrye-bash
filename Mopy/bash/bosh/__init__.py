...
class ModInfo(_BackupMixin, FileInfo):
    ...
    def needs_update(self): # TODO(ut) mark as updated if ghost state changed ?
    ...
    def setGhost(self,isGhost):
        ...
        # Both should never exist simultaneously, Bash will warn
...
class BSAInfo(_BackupMixin, FileInfo, _bsa_type):
    ...
    def __init__(self, parent_dir, bsa_name, load_cache=True): #load_cache True
        try:
            super(BSAInfo, self).__init__(parent_dir, bsa_name, load_cache)
        except BSAError as e:
